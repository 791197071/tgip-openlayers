...
var SwitcherMapComponent = /** @class */ (function () {
    function SwitcherMapComponent() {
        /**
         * 输出参数
         */
    ...
    Object.defineProperty(SwitcherMapComponent.prototype, "config", {
        get: /**
         * @return {?}
         */
        function () {
     ...
     * @return {?}
     */
    SwitcherMapComponent.prototype.fullscreenToggle = 
    // 点击选中
    /**
     * @param {?} item
     * @return {?}
    ...
    function (item) {
        ...
        this.flag = true;
        this.config.baseMap.forEach(function (value) {
     ...
     * @return {?}
     */
    SwitcherMapComponent.prototype.mouseenter = 
    // 鼠标移入
    /**
     * @return {?}
     */
     ...
     * @return {?}
     */
    SwitcherMapComponent.prototype.mouseleave = 
    // 鼠标移出
    /**
     * @return {?}
     */
     ...
     * @return {?}
     */
    SwitcherMapComponent.prototype.ngOnInit = /**
     * @return {?}
     */
    function () { };
    ...
    /** @nocollapse */
    SwitcherMapComponent.ctorParameters = function () { return []; };
    SwitcherMapComponent.propDecorators = {
        outer: [{ type: Output }],
        config: [{ type: Input, args: ['config',] }]
    };
    return SwitcherMapComponent;
}());
export { SwitcherMapComponent };
if (false) {
    /**
     * 输出参数
     * @type {?}
