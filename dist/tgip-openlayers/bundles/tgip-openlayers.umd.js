(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('handsmap-map-client/openlayers/ProjThree'), require('ngx-swiper-wrapper'), require('handsmap-map-client/openlayers/Map'), require('handsmap-map-client/openlayers/View'), require('ol/style'), require('handsmap-map-client/openlayers/util'), require('handsmap-map-client/openlayers/layer'), require('@angular/core'), require('ol/Overlay.js')) :
    typeof define === 'function' && define.amd ? define('tgip-openlayers', ['exports', 'rxjs', 'handsmap-map-client/openlayers/ProjThree', 'ngx-swiper-wrapper', 'handsmap-map-client/openlayers/Map', 'handsmap-map-client/openlayers/View', 'ol/style', 'handsmap-map-client/openlayers/util', 'handsmap-map-client/openlayers/layer', '@angular/core', 'ol/Overlay.js'], factory) :
    (factory((global['tgip-openlayers'] = {}),global.rxjs,global.ProjThree,global.ngxSwiperWrapper,global._Map,global.View,global.style,global.util,global.layer,global.ng.core,global.Overlay));
}(this, (function (exports,rxjs,ProjThree,ngxSwiperWrapper,_Map,View,style,util,layer,core,Overlay) { 'use strict';
    ...
    var FullScreenComponent = /** @class */ (function () {
         ...
         */
            function () {
                var _this = this;
                this.subscription = rxjs.fromEvent(document, 'fullscreenchange').subscribe(function (event) {
                    console.log(event);
                    /** @type {?} */
            ...
            function () {
                if (this._map) {
                    ...
                    if (this._map.config.coordinateSystimSrid === 'EPSG:3857') {
                        center = ProjThree.ProjThree.ll2webmerc(center);
                    }
    ...
    var SwitcherMapComponent = /** @class */ (function () {
        function SwitcherMapComponent() {
             ...
             * 输出参数
             */
            this.outer = new core.EventEmitter();
            this.defaultConfig = {
                backgroundSize: {
    ...
    var ZoomMapComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        ZoomMapComponent.ctorParameters = function () {
            return [
        ...
        ZoomMapComponent.propDecorators = {
            outer: [{ type: core.Output }],
            map: [{ type: core.Input, args: ['map',] }],
            mapconfig: [{ type: core.ViewChild, args: ['myMap',] }],
            config: [{ type: core.Input, args: ['config',] }]
        };
    ...
    var MapComponent = /** @class */ (function () {
         ...
         */
            function (config) {
                ...
                this.map = new _Map.Map({
                    ...
                    view: View.View.getViewByHmapserver(mapParams),
                });
                this.xyzLayer = layer.TileXYZLayer.getTileXYZLayerByHmapserver(mapParams);
         ...
         */
            function () {
                ...
                this.xyzLayer = layer.TileXYZLayer.getTileXYZLayerByHmapserver(this.config);
                this.map.addLayer(this.xyzLayer);
            };
        /**
         * @param {?} changes
        ...
        MapComponent.propDecorators = {
            setConfig: [{ type: core.Input, args: ['config',] }],
            configUrl: [{ type: core.Input }]
        };
        return MapComponent;
    }());
    ...
    var LayerControlPc1Component = /** @class */ (function () {
        function LayerControlPc1Component() {
            this.outer = new core.EventEmitter(); // 广播事件
            // 广播事件
            this.mySwiper = {};
            // @Input() config: any;
            this.mutex = false; // 互斥
    ...
    var PointLayerComponent = /** @class */ (function () {
        ...
        Object.defineProperty(PointLayerComponent.prototype, "setData", {
           ...
           */
             ...
             */ function (value) {
                ...
                if (this._map.config.coordinateSystimSrid === 'EPSG:3857') {
                    dataR = util.ServiceUtil.ConvertPointsll2tmerc(value, coordFieldConfig); // dataR
                }
                // 先清空，再增加
                this._data = value;
        ...
        PointLayerComponent.prototype.initLayer =
             ...
             */
            function () {
                this.pointLayer = new layer.PointLayer({
                ...
                // 默认样式问题
                /** @type {?} */
                var defaultStyle = new style.Style({
        ...
        PointLayerComponent.propDecorators = {
            setStyle: [{ type: core.Input, args: ['style',] }],
            setConfig: [{ type: core.Input, args: ['config',] }],
            setVisible: [{ type: core.Input, args: ['visible',] }],
            setMap: [{ type: core.Input, args: ['map',] }],
            setData: [{ type: core.Input, args: ['data',] }]
        };
    ...
    var LineLayerComponent = /** @class */ (function () {
        ...
        Object.defineProperty(LineLayerComponent.prototype, "setData", {
           ...
           */
             ...
             */ function (value) {
                ...
                if (this._map.config.coordinateSystimSrid === 'EPSG:3857') {
                    dataR = util.ServiceUtil.ConvertLinesll2tmerc(value, coordFieldConfig); // dataR
                }
                // 先清空，再增加
                this._data = value;
        ...
        LineLayerComponent.prototype.initLayer =
             ...
             */
            function () {
                this.lineLayer = new layer.LineLayer({
                    layerName: 'lineLayer',
                    infoTemplate: '',
                    dataList: [],
                    coordsField: { x: 'coordinates', y: 'coordinates' }
    ...
    var PolygonLayerComponent = /** @class */ (function () {
        ...
        Object.defineProperty(PolygonLayerComponent.prototype, "setData", {
             ...
             */ function (value) {
                ...
                var coordFieldConfig = { wktField: this._config['coordsField'] };
                if (this._map.config.coordinateSystimSrid === 'EPSG:3857') {
                    dataR = util.ServiceUtil.ConvertPolygonsll2tmerc()(value, coordFieldConfig); // dataR
                }
                // 先清空，再增加
                this._data = value;
        ...
        PolygonLayerComponent.prototype.initLayer =
             ...
             */
            function () {
                this.polygonLayer = new layer.PolygonLayer({
    ...
    var TgipOpenlayersModule = /** @class */ (function () {
        ...
        TgipOpenlayersModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [ngxSwiperWrapper.SwiperModule],
                        providers: [
                            {
                                provide: ngxSwiperWrapper.SWIPER_CONFIG,
                                useValue: ɵ0
                            }
                        ],
                        exports: [
    ...
    exports.TgipOpenlayersModule = TgipOpenlayersModule;
    exports.FullScreenComponent = FullScreenComponent;
    exports.SwitcherMapComponent = SwitcherMapComponent;
    exports.ZoomMapComponent = ZoomMapComponent;
    exports.FullExtentComponent = FullExtentComponent;
    exports.MapComponent = MapComponent;
    exports.LayerControlPc1Component = LayerControlPc1Component;
    exports.LayerControlPc2Component = LayerControlPc2Component;
    exports.LayerControlPc3Component = LayerControlPc3Component;
    exports.PointLayerComponent = PointLayerComponent;
    exports.LineLayerComponent = LineLayerComponent;
    exports.PolygonLayerComponent = PolygonLayerComponent;
    exports.CompassComponent = CompassComponent;
    exports.HeatmapLegendComponent = HeatmapLegendComponent;
    exports.ScenicLegendComponent = ScenicLegendComponent;
    exports.ScenicBoxComponent = ScenicBoxComponent;
    exports.SpotBoxComponent = SpotBoxComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=tgip-openlayers.umd.js.map